...
def main() -> int:
    ...
    report = {
        "environment": {
            ...
            "provider_allocated_vcpus": config["provider_allocated_vcpus"],
            "provider_ram_gb": config["provider_ram_gb"],
            "provider_cost_per_hour_usd": config["provider_cost_per_hour_usd"],
            "container_visible_logical_cpus": cpu_allocation(),
            "seed": config["seed"],
        },
        "stage": config["stage"],
        "claims": {},
